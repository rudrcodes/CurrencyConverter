...
function CurrencyConverter() {
    ...
    return (
        ...
        <Form onSubmit={handleSubmit} className='w-[290px] border border-gray-400 md:min-h-[500px] bg-gray-200 p-4 md:min-w-[400px] rounded-lg flex justify-center items-center flex-col'>
